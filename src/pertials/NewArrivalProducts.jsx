                    ...
                    <div class="col col-lg-5">
                        <div class="deals_product_layout1">
                            <div class="bg_area">
                                ...
                                <a class="btn btn_primary" to="shop_details.html">Shop Now</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="new-arrivals-grids clearfix">
                            <div class="grid">
                                <div class="product-pic">
                                    <img src="/public/images/shop/product-img-28.png" alt/>
                                    <div class="actions">
                                        <ul>
                                            <li>
                                            ...
                                            <li>
                                                <Link to="#"><svg width="48px" height="48px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" stroke="#2329D6" stroke-width="1" stroke-linecap="square" stroke-linejoin="miter" fill="none" color="#2329D6"> <title>Visible (eye)</title> <path d="M22 12C22 12 19 18 12 18C5 18 2 12 2 12C2 12 5 6 12 6C19 6 22 12 22 12Z"/> <circle cx="12" cy="12" r="3"/> </svg></Link>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="details">
                                    <h4><Link to="#">iPhone 13 pro</Link></h4>
                            ...
                            <div class="grid">
                                <div class="product-pic">
                                    <img src="/public/images/shop/product-img-26.png" alt/>
                                ...
                                <div class="details">
                                    <h4><Link to="#">Apple</Link></h4>
                                    <p><Link to="#">Apple MacBook Pro13.3″ Laptop with Touch bar ID </Link></p>
                                    <span class="price">
                                        <ins>
                                            <span class="woocommerce-Price-amount amount">
                                                <bdi>
                            ...
                            <div class="grid">
                                <div class="product-pic">
                                    <img src="/public/images/shop/product-img-27.png" alt/>
