        ...
        <Base>
            <section className="blog-pg-section section_space">
                <div className="container">
                    <div className="row">
                        <div className="col col-lg-8 content">
                            <div className="blog-content">
                                ...
                                <div className="post format-quote">
                                    <div className="entry-details">
                                        <div className="author">By: <Link to="#">Hendrt</Link></div>
                                ...
                                <div className="post format-standard-image">
                                    ...
                                    <div className="entry-details">
                                        <div className="author">By: <Link to="#">Hendrt</Link></div>
                                        <h3><Link to="#">Familiar with the countless indescribabl</Link></h3>
                                        <div className="entry-meta">
                                            <ul>
                                                <li><Link to="#">5 Mins Read</Link></li>
                                                <li><Link to="#">10 OCT 2021</Link></li>
                                ...
                                <div className="pagination-wrapper pagination-wrapper-left">
                                    <ul className="pg-pagination">
                                        ...
                                        <li className="active"><a to="#">1</a></li>
