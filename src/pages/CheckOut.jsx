                  ...
                  <div className="row">
                     <div className="col col-xs-12">
                        <div className="woocommerce">
                           <div className="woocommerce-info">Returning customer? <Link to="#" className="showlogin">Click here to login</Link></div>
                           <form method="post" className="login" >
                              ...
                              <p className="lost_password">
                                 <Link to="http://localhost/wp/?page_id=7&amp;lost-password">Lost your password?</Link>
                              </p>
                              <div className="clear"></div>
                           </form>
                           <div className="woocommerce-info">Have a coupon? <Link to="#" className="showcoupon">Click here to enter your code</Link></div>
                                 ...
                                 <div id="payment" className="woocommerce-checkout-payment">
                                    ...
                                    {/* <ul className="wc_payment_methods payment_methods methods">
                                       ...
                                       <li className="wc_payment_method payment_method_paypal">
                                          ...
                                          PayPal <img src="/public/images/paypal.png" alt="PayPal Acceptance Mark" /><a to="#" className="about_paypal" title="What is PayPal?">What is PayPal?</a> </label>
