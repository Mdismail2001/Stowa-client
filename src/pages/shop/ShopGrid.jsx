                                    ...
                                    <div className="filter_sidebar">
                                        ...
                                        <div className="fs_widget">
                                            ...
                                            <ul className="filter_memory_list ul_li_block">
                                                <li>
                                                    <Link to="#!">256 GB or more <span>(12)</span></Link>
                                                </li>
                                                <li>
                                                    <Link to="#!">128 GB <span>(12)</span></Link>
                                                </li>
                                                <li>
                                                    <Link to="#!">16 GB <span>(6)</span></Link>
                                                </li>
                                                <li>
                                                    <Link to="#!">32 GB <span>(7)</span></Link>
                                                </li>
                                                <li>
                                                    <Link to="#!">64 GB <span>(9)</span></Link>
                                                </li>
                                                <li>
                                                    <Link to="#!">8 GB or less <span>(8)</span></Link>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div className="row align-items-center">
                                    <div className="col col-md-4">
                                        <ul className="layout_btns nav" role="tablist">
                                            <li>
                                                <button className="active" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true"><i className="fal fa-bars"></i></button>
                                            </li>
                                            <li>
                                        ...
                                        <div className="product-area shop-grid-product-area clearfix">
                                            <div className="grid">
                                                <div className="product-pic">
                                                    ...
                                                    <div className="actions">
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <Link className="quickview_btn" data-bs-toggle="modal" to="#quickview_popup" role="button" tabindex="0">
                                                                    <svg
                                                                        width="48px"
                                                                        height="48px"
                                                                        viewBox="0 0 24 24"
                                                ...
                                                <div className="details">
                                                    ...
                                                    <p><Link to="#">Apple MacBook Pro13.3″ Laptop with Touch ID </Link></p>
                                            ...
                                            <div className="grid">
                                                ...
                                                <div className="details">
                                                    ...
                                                    <p><Link to="#">Apple Watch Series 7 case Pair any band </Link></p>
                                                    <div className="rating">
                                                        <i className="fas fa-star"></i>
                                                        <i className="fas fa-star"></i>
                                                        <i className="fas fa-star"></i>
                                            ...
                                            <div className="grid">
                                                ...
                                                <div className="details">
                                                    ...
                                                    <p><Link to="#">The ultimate iPad experience all over the world </Link></p>
                                                    <div className="rating">
                                                        <i className="fas fa-star"></i>
                                                        <i className="fas fa-star"></i>
                                                        <i className="fas fa-star"></i>
                                            ...
                                            <div className="grid">
                                                ...
                                                <div className="details">
                                                    ...
                                                    <p><Link to="#">Apple iMac 29″ Laptop with Touch ID for you </Link></p>
                                                    <div className="rating">
                                                        <i className="fas fa-star"></i>
                                                        <i className="fas fa-star"></i>
                                                        <i className="fas fa-star"></i>
                                    ...
                                    <div className="pagination_wrap">
                                        <ul className="pagination_nav">
                                            ...
                                            <li className="prev_btn">
                                                <Link to="#!"><i className="fal fa-angle-left"></i></Link>
                                            </li>
                                            <li className="next_btn">
                                                <Link to="#!"><i className="fal fa-angle-right"></i></Link>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
