                ...
                <div className="container">
                    ...
                    <div className="product_details_image">
                        ...
                        <div className="slider_item">
                            <img
                            src="/public/images/details/product_details_img_1.png"
                            alt="image_not_found"
                            />
                        </div>
                        <div className="slider_item">
                            <img
                            src="/public/images/details/product_details_img_2.png"
                            alt="image_not_found"
                            />
                        </div>
                        <div className="slider_item">
                            <img
                            src="/public/images/details/product_details_img_3.png"
                            alt="image_not_found"
                            />
                        </div>
                        <div className="slider_item">
                            <img
                            src="/public/images/details/product_details_img_4.png"
                            alt="image_not_found"
                            />
                        </div>
                        <div className="slider_item">
                        ...
                        <div className="col-lg-6">
                            ...
                            <div className="product_details_content">
                                ...
                                <form action="#">
                                    ...
                                    <span className="repuired_text">Required Fields *</span>
                                </form>
                                </div>
                                ...
                                <li><a className="btn btn_primary addtocart_btn" to="#!">Add To Cart</a></li>
                                <li><a to="#!"><i className="far fa-compress-alt"></i></a></li>
                                <li><a to="#!"><i className="fas fa-heart"></i></a></li>
                                </ul>

                                <ul className="default_share_links ul_li">
                                <li>
                                    <a className="facebook" to="#!">
                                    <span><i className="fab fa-facebook-square"></i> Like</span>
                                    <small>10K</small>
                                    </a>
                                </li>
                                <li>
                                    <a className="twitter" to="#!">
                                    <span><i className="fab fa-twitter-square"></i> Tweet</span>
                                    <small>15K</small>
                                    </a>
                                </li>
                                <li>
                                    <a className="google" to="#!">
                                    <span><i className="fab fa-google-plus-square"></i> Google+</span>
                                    <small>20K</small>
                                    </a>
                                </li>
                                <li>
                                    <a className="share" to="#!">
                    ...
                    <div className="details_information_tab">
                        <ul className="tabs_nav nav ul_li" >
                            <li>
