                            ...
                            <aside className="sidebar_section p-0 mt-0">
                                <div className="sb_widget sb_category">
                                    ...
                                    <ul className="sb_category_list ul_li_block">
                                        <li>
                                            <Link to="#!">Official electronic <span></span></Link>
                                        </li>
                                        <li>
                                            <Link to="#!">Dell <span>(1375)</span></Link>
                                        </li>
                                        <li>
                                            <Link to="#!">Asus <span>(1687)</span></Link>
                                        </li>
                                        <li>
                                            <Link to="#!">HP <span>(1036)</span></Link>
                                        </li>
                                        <li>
                                            <Link to="#!">Acer <span>(202)</span></Link>
                                        </li>
                                        <li>
                                            <Link to="#!">Aivta <span>(525)</span></Link>
                                        </li>
                                        <li>
                                            <Link to="#!">HP <span>(135)</span></Link>
                                        </li>
                                        <li>
                                            <Link to="#!">Apple <span>(298)</span></Link>
                                        </li>
                                        <li>
                                            <Link to="#!"><span>All Categories</span></Link>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <div className="filter_sidebar">
                                        ...
                                        <div className="fs_widget">
                                            ...
                                            <ul className="filter_memory_list ul_li_block">
                                                <li>
                                                    <a to="#!">256 GB or more <span>(12)</span></a>
                                                </li>
                                                <li>
                                                    <a to="#!">128 GB <span>(12)</span></a>
                                                </li>
                                                <li>
                                                    <a to="#!">16 GB <span>(6)</span></a>
                                                </li>
                                                <li>
                                                    <a to="#!">32 GB <span>(7)</span></a>
                                                </li>
                                                <li>
                                                    <a to="#!">64 GB <span>(9)</span></a>
                                                </li>
                                                <li>
                                                    <a to="#!">8 GB or less <span>(8)</span></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div className="row align-items-center">
                                    <div className="col col-md-4">
                                        <ul className="layout_btns nav" role="tablist">
                                            <li>
                                                <button data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true"><i className="fal fa-bars"></i></button>
                                            </li>
                                            <li>
                                                <button className="active" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">
                                        ...
                                        <div className="product-area shop-grid-product-area clearfix">
                                            <div className="grid">
                                                <div className="product-pic">
                                                    ...
                                                    <div className="actions">
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <a className="quickview_btn" data-bs-toggle="modal" to="#quickview_popup" role="button" tabindex="0">
                                                                    <svg
                                                                        width="48px"
                                                                        height="48px"
                                                                        viewBox="0 0 24 24"
                                                ...
                                                <div className="details">
                                                    <h4><a to="#">Macbook Pro</a></h4>
                                                    <p><a to="#">Apple MacBook Pro13.3″ Laptop with Touch ID </a></p>
                                                    ...
                                                    <span className="price">
                                                        <ins>
                                                            <span className="woocommerce-Price-amount amount">
                                                                <bdi> <span className="woocommerce-Price-currencySymbol">$</span>471.48 </bdi>
                                                            </span>
                                                        </ins>
                                                    </span>
                                            ...
                                            <div className="grid">
                                                ...
                                                <div className="details">
                                                    <h4><a to="#">Apple Watch</a></h4>
                                                    <p><a to="#">Apple Watch Series 7 case Pair any band </a></p>
                                                    <div className="rating">
                                                        <i className="fas fa-star"></i>
                                                        <i className="fas fa-star"></i>
                                                        <i className="fas fa-star"></i>
                                                ...
                                                <div className="details">
                                                    ...
                                                    <span className="price">
                                                        ...
                                                        <del aria-hidden="true">
                                                            <span className="woocommerce-Price-amount amount">
                                                                <bdi> <span className="woocommerce-Price-currencySymbol">$</span>904.21 </bdi>
                                                            </span>
                                                        </del>
                                                    </span>
                                                    <div className="add-cart-area">
                                            ...
                                            <div className="grid">
                                                ...
                                                <div className="details">
                                                    <h4><a to="#">iPad mini</a></h4>
                                                    <p><a to="#">The ultimate iPad experience all over the world </a></p>
                                                    <div className="rating">
                                                        <i className="fas fa-star"></i>
                                                        <i className="fas fa-star"></i>
                                                        <i className="fas fa-star"></i>
                                            ...
                                            <div className="grid">
                                                ...
                                                <div className="details">
                                                    <h4><a to="#">Imac 29"</a></h4>
                                                    <p><a to="#">Apple iMac 29″ Laptop with Touch ID for you </a></p>
                                                    <div className="rating">
                                                        <i className="fas fa-star"></i>
                                                        <i className="fas fa-star"></i>
                                                        <i className="fas fa-star"></i>
                                            ...
                                            <div className="grid">
                                                ...
                                                <div className="details">
                                                    <h4><a to="#">iPhone 13</a></h4>
                                                    <p><a to="#">A dramatically more powerful camera system a display</a></p>
                                                    <div className="rating">
                                                        <i className="fas fa-star"></i>
                                                        <i className="fas fa-star"></i>
                                                        <i className="fas fa-star"></i>
                                    ...
                                    <div className="pagination_wrap">
                                        <ul className="pagination_nav">
                                            ...
                                            <li className="prev_btn">
                                                <a to="#!"><i className="fal fa-angle-left"></i></a>
                                            </li>
                                            <li className="next_btn">
                                                <a to="#!"><i className="fal fa-angle-right"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
